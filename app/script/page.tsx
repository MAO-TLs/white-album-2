...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Browse all 77,198 main-game and Special Contents lines beside the v2.1.0 MAO English translation.",
    ...
    <main className="reader-page">
      <header className="reader-header">
        ...
        <div className="reader-intro shell">
          <p className="eyebrow">Script Version v2.1.0</p>
          <h1>Script browser</h1>
          <p>
            Search the complete 77,198-line corpus or read any of its 254
            scripts beside the v2.1.0 MAO English translation. An optional
