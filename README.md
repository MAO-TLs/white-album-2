...
[Complete v1.3.3 release](https://github.com/MAO-TLs/white-album-2/releases/download/v1.3.3/White_Album_2_Complete_English_Release_v1.3.3.zip)
...
release. v1.3.3 adds thirteen narrowly scoped, source-reviewed texture
corrections over v1.3.2, restoring concrete metaphors, jokes, and deliberately
strange images that had been over-naturalized. Every other English row is
byte-identical to v1.3.2. The final text contains 13,524 accepted changes:
12,835 in the main game, 607 in Special Contents, and 82 in the audio dramas.
...
locally smoke-tested. v1.3.3 passed exhaustive static presentation,
